...
class UiMainWindow(object):
    def make_central_widget(self, main_window):
    ...
    def make_option_widget(self):
        ...
        self.duration_slider = self.make_slider("duration_slider", (270, 330), 0, 100)
        ...
        self.duration_horizontal_slider = self.make_horizontal_slider("horizontalSlider", (270, 380), 10, 120)

        self.v_dur_display = self.make_lcd_display("v_dur_display", (470, 380), 91, 32)

        self.video_path = self.make_line("video_path", (270, 180))

        self.screen_path = self.make_line("screen_path", (270, 230))
    ...
    def setupUi(self, main_window):
        main_window.setObjectName("SchoolSchooter47")
        main_window.resize(875, 612)
        main_window.setMinimumSize(QtCore.QSize(875, 612))
        main_window.setMaximumSize(QtCore.QSize(875, 612))

        self.central_widget = self.make_central_widget(main_window)
        ...
        self.option_button = self.make_menu_button("option_button", ":/icon/settings_cogwheel_options_icon_149387.png")

        self.menu_vertica_layout.addWidget(self.option_button)

        self.video_button = self.make_menu_button("video_button",
                                                  ":/icon/movie-symbol-of-video-camera_icon-icons.com_72981.png")

        self.menu_vertica_layout.addWidget(self.video_button)

        self.editor_button = self.make_menu_button("editor_button",
                                                   ":/icon/iconfinder-videoeditingeditorslicecrop-3993845_112640.png")
        ...
        self.exit_button = self.make_menu_button("exit_button", ":/icon/powercircleandlinesymbol_118369.png")
        ...
        self.duration_slider.valueChanged['int'].connect(self.duration_display.display)
